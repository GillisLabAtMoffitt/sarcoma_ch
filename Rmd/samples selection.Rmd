...
samples <- blood_patients %>% 
  ...
  select(deidentified_patient_id, blood_bf_topoII, blood_during_topoII, blood_af_topoII, days_from_presample_to_topo, days_from_topo_to_seqsample, treatment) %>% 
  # pivot_wider(id_cols = c(deidentified_patient_id),
  #             names_from = treatment_line, 
  #             values_from = treatment) %>% 
  group_by(deidentified_patient_id, blood_bf_topoII, blood_af_topoII, blood_during_topoII, days_from_presample_to_topo, days_from_topo_to_seqsample) %>% 
