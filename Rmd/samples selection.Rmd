...
samples_chemo <- blood_patients %>%
  ...
  select(mrn, deidentified_patient_id, 
         date_of_diagnosis1, sample_type, 
         have_good_presample_chemo, blood_af_chemo, 
         days_from_presample_to_chemo,
...
write_csv(samples_chemo, "list of samples chemo.csv")
```
...
samples_topo <- blood_patients %>% 
  ...
  select(mrn, deidentified_patient_id, sample_type, blood_bf_topoII, blood_during_topoII, 
         blood_af_topoII, days_from_drugsend_to_after_sample, treatment, 
  ...
  group_by(mrn, deidentified_patient_id, sample_type, blood_bf_topoII, blood_af_topoII,
           blood_during_topoII, days_from_drugsend_to_after_sample, treatment_start_date, 
           duration_of_treatment) %>% 
  ...
  filter(!deidentified_patient_id %in% 
           c("sarcoma_study_000153", "sarcoma_study_000155", "sarcoma_study_000164",
             "sarcoma_study_000315", "sarcoma_study_000357", "sarcoma_study_000437",
             "sarcoma_study_000559", "sarcoma_study_000861")) %>% 
  select(#mrn, 
         deidentified_patient_id, sample_type, #blood_bf_topoII, 
         blood_during_topoII, 
...
samples_alk <- blood_patients %>%
  ...
  select(mrn, deidentified_patient_id, date_of_diagnosis1, sample_type, have_good_presample_alk, blood_af_alk, 
         days_from_presample_to_alk, days_from_drugsend_to_after_sample, treatment, 
         treatment_start_date, treatment_end_date, duration_of_treatment) %>% 
  group_by(mrn, deidentified_patient_id, date_of_diagnosis1, sample_type, have_good_presample_alk, blood_af_alk,
  ...
  separate(treatment, paste("regimen", 1:2, sep = "_"), 
           ...
           extra = "warn", fill = "right") %>% 
  filter(!deidentified_patient_id %in% 
           c("sarcoma_study_000095", "sarcoma_study_000214", "sarcoma_study_000899")) %>%  
  select(#mrn, 
         deidentified_patient_id, sample_type, 
         have_good_presample_alk, blood_af_alk, 
         days_from_presample_to_alk, days_from_drugsend_to_after_sample,
         starts_with("regimen"), 
         duration_of_treatment)
